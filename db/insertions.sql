...
INSERT INTO
    tb_street_types (id_street_type, des_street_type, des_acronym, dt_street_type_created_at)
VALUES
    (1, 'Aeroporto', 'AER', NOW()),
    (2, 'Alameda', 'AL', NOW()),
    (3, 'Área', 'A', NOW()),
    ...
    (6, 'Chácara', 'CH', NOW()),
    (7, 'Colônia', 'COL', NOW()),
    (8, 'Condomínio', 'CON', NOW()),
    (9, 'Conjunto', 'CJ', NOW()),
    (10, 'Distrito', 'DT', NOW()),
    (11, 'Esplanada', 'ESP', NOW()),
    (12, 'Estação', 'ETC', NOW()),
    (13, 'Estrada', 'ESTR', NOW()),
    (14, 'Favela', 'FAV', NOW()),
    (15, 'Fazenda', 'FAZ', NOW()),
    ...
    (20, 'Lagoa', 'LGA', NOW()),
    (21, 'Largo', 'LG', NOW()),
    (22, 'Loteamento', 'LOT', NOW()),
    (23, 'Morro', NULL, NOW()),
    (24, 'Núcleo', NULL, NOW()),
    (25, 'Parque', 'PQ', NOW()),
    (26, 'Passarela', NULL, NOW()),
    (27, 'Pátio', 'PAT', NOW()),
    (28, 'Praça', 'PC', NOW()),
    (29, 'Quadra', 'QD', NOW()),
    (30, 'Recanto', NULL, NOW()),
    (31, 'Residencial', 'RES', NOW()),
    (32, 'Rodovia', 'ROD', NOW()),
    (33, 'Rua', 'R', NOW()),
    (34, 'Setor', NULL, NOW()),
    (35, 'Sítio', 'SIT', NOW()),
...
VALUES
    (1, 'Contato', 'contato@luizamichi.com.br', NULL, 'Parabéns', 'Meus parabéns pela inauguração da loja online.', NOW()),
    (2, 'Contact', 'contact@luizamichi.com.br', NULL, 'Dúvida', 'Gostaria de saber se é possível realizar o pagamento pelo cartão de crédito.', NOW());
